...
if [ ! $token ]; then
echo "✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE dragonubn.lua \e[0m"
echo "✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local f = io.open("./dragonubn.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./dragonubn.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/NightRang/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "S0DRG")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.")  
...
send(msg.chat_id_, msg.id_," 𖠪 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
local NIU_C = database:get(bot_id..'text:ch:user')
if NIU_C then
...
if DevSoFi(msg) then
local bl = ' 𖠪 اهلا عزيزي آلمـطـور\n 𖠪 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 𖠪 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖠪 من خلاال الكيبورت خاص بك\n 𖠪 قناة سورس البوت [اضغط هنا](t.me/S0DRG)'
local keyboard = {
{'الاحصائيات ℘'},
{'تعطيل التواصل ℘','تفعيل التواصل ℘'},
{'ضع اسم للبوت ℘','قائمه العام ℘','قائمه الكتم العام ℘'},
{'🐉 حصريات و تحديثات دراكـون 🐉'},
{'المطورين ℘','الثانويين ℘'},
{'المشتركين ℘','الجروبات ℘'},
...
SourceDRAGONr = ' 𖠪 اهلا عزيزي\n 𖠪 انا بوت اسمي ' ..Namebot..'\n 𖠪 اختصاصي حمايه الجروبات\n 𖠪 من تكرار والسبام والتوجيه والخ…\n 𖠪 لتفعيلي اتبع الاخطوات…↓\n 𖠪 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ 𖠪 معرف المطور ['..UserName..']'
end 
...
os.execute('wget https://raw.githubusercontent.com/ahmedawad10/RISK/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖠪 تم تحديث السورس \n 𖠪 لديك اخر اصدار لسورس دراكون\n 𖠪 الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖠪 اصدار سورس دراكون \n 𖠪 الاصدار »{ v 1.6 }')
end
...
-------------
if text == "🐉 حصريات و تحديثات دراكـون 🐉" and DevSoFi(msg) then  
local updatech =[[
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖠪 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖠪 تم ازالة » { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖠪 تم ازالة » {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖠪  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖠪  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_,msg.id_," 𖢠 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖢠 العضو ⤶ ['..result.title_..'](t.me/'..(username or 'NIU_C')..')'
status  = '\n 𖢠 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖢠 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖢠 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'NIU_C')..')'
status  = '\n 𖢠 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠪 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 𖠪 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖠪 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖠪 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 𖠪 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," 𖠪 العضو : {["..data.first_name_.."](T.ME/S0DRG)}\n 𖠪 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖠪 عذرا » {["..data.first_name_.."](T.ME/S0DRG)}\n 𖠪 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, '𖠪 تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖠪 تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '𖠪 تم تفعيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖠪 تم تعطيل تنبيه الاسماء')
...
send(msg.chat_id_, msg.id_, '𖠪 تم تفعيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖠪 تم تعطيل تنبيه المعرف')
...
send(msg.chat_id_, msg.id_, '𖠪 تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '𖠪 تم تعطيل تنبيه الصور')
...
local Text = [[
💌لتنصيب بوت بحقوقك ع سورس ريسك اتبع الازرار💌
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' <｟ 𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 ｠ <',url="t.me/AAHMEED11"}},
...
if text == 'ماديريسك' or text == 'احمد' or text == 'مبرمج السورس' then
local Text = [[
ماديريسك مبرمج السورس
اتبع الزر إلى تحت ↓

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' <｟ 𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧 ｠ <',url="t.me/U880p"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖠪 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 𖠪 تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 𖠪 تم تفعيل امر كول'
database:del(bot_id..'Speak:after:me'..msg.chat_id_)  
else
Text = ' 𖠪 بالتاكيد تم تفعيل امر كول'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠪 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'S0DRG')..') \n 𖠪 تـم قفـل التاك بالكتم ')
end,nil)   
...
usertext = '\n 𖠪 العضو » ['..result.title_..'](t.me/'..(username or 'S0DRG')..')'
status  = '\n 𖠪 تم حظره عام من الجروبات'
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/NightRang/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖠪 اهلا بك في متجر ملفات دراكون\n 𖠪 ملفات السورس ↓\n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n\n"
local TextE = "\n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n 𖠪 علامة تعني { ✔️ } ملف مفعل\n 𖠪 علامة تعني { ✖ } ملف معطل\n 𖠪 قناة سورس دراكون ↓\n".." 𖠪 [اضغط هنا لدخول](t.me/S0DRG) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/NightRang/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖠪 عذرا الملف لايدعم سورس دراكون \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖢠 لا ����ستطيع استخدام البوت \n  𖢠 يرجى الاشتراك بالقناه اولا \n  𖢠 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
local UserName = (b.username_ or "Bandaa2")
...
send(msg.chat_id_, msg.id_, "\n𖠪 تم مسح قائمة المطورين الثانويين  ")
end
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖠪 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖠪 العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم مسح جميع المطايه')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖠪 قائمة مطايه الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖠪 تم رفع العضو مطي في الجروب \n 𖠪 تعال حبي استلم العربانه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل العضو مطي في الجروب\n 𖠪 تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم مسح جميع الحاتات')
end
if text == ("تاك للحاتات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖠪 قائمه حاتات الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
local  statuss  = '\n 𖠪 تم رفع العضــو الحاته في الجروب \n 𖠪 تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل العضــو الحاته من الجروب\n 𖠪 مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم مسح جميع الصاكين')
end
if text == ("تاك للصاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n 𖠪 قائمه صاكين الجروب \nٴ✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖠪 تم رفع العضــو الصاك في الجروب \n 𖠪 تعال حبي الصاك نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل العضــو الصاك من الجروب\n 𖠪 مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع صخوله من الجروب')
end
if text == ("تاك للصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n 𖠪 قائمة صخوله الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع المتهم صخل بالجروب\n 𖠪 الان اصبح صخل الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع جلاب الجروب')
end
if text == ("تاك للجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖠪 قائمة الجلاب الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع جلب في الجروب\n 𖠪 تعال حبي اطيك عضمه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع القروده بالجروب')
end
if text == ("تاك للقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖠪 قائمة القروده الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع ضلع في الجروب\n 𖠪 تعال حبيبي انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل ضلع من الجروب\n 𖠪 بعد لتراويني وجهك ياحقير وجيب فلوس الشرب'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع ضلعه في الجروب\n 𖠪 تعاي صرتي من ضلعاتي تمكيجي وخل نروح للمول نرقم صاكين'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل ضلعه من الجروب\n 𖠪 دمشي ولي ملطخه وجهه تلطخ وتريد ترقم صاكين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تنزيل جميع طليان بالجروب')
end
if text == ("تاك للطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 𖠪 قائمة الطليان الجروب \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع الطلي في الجروب\n 𖠪 طلع برا ابو البعرور الوصخ'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
status  = '\n 𖠪 تم تنزيل زاحف من الجروب\n 𖠪 هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠪 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'S0DRG')..')'
local  statuss  = '\n 𖠪 تم رفع جريذي في الجروب\n 𖠪 خايس ريحتك موتتنه روح سبح يع'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
' }\n'..' 𖠪  امر مين ضافني » { '..addme..
' }\n'..' 𖠪  ردود المدير » { '..rdmder..
' }\n'..' 𖠪  ردود المطور » { '..rdsudo..
' }\n'..' 𖠪  الايدي » { '..idgp..
...
GetWelcome = ' 𖠪 لم يتم تعيين ترحيب للجروب'
end 
...
local f = ' 𖠪 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖠪 ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖠪 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'S0DRG')..')'..'\n 𖠪 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖠪تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,"𖠪تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,"𖠪تم حفظ الرد بنجاح")
return false  
end  
end
...
send(msg.chat_id_, msg.id_,"𖠪 ارسل الكلمه التري تريد اضافتها")
...
send(msg.chat_id_, msg.id_,"𖠪 ارسل الكلمه التري تريد حذفها")
database:set(bot_id.."Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '𖠪الان ارسل الرد الذي تريد اضافته \n𖠪 قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n𖠪 يمكنك اضافه الى النص :\n𖠪🌐 `#username` > معرف المستخدم\n𖠪📨 `#msgs` > عدد رسائل المستخدم\n𖠪📎 `#name` > اسم المستخدم\n𖠪🆔 `#id` > ايدي المستخدم\n𖠪🎖 `#stast` > رتبه المستخدم \n𖠪📝 `#edit` > عدد السحكات ')
...
send(msg.chat_id_, msg.id_,"𖠪تم ازالة الرد من قائمه ردود المطور")
...
send(msg.chat_id_, msg.id_,"𖠪تم مسح ردود المدير")
end
if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "𖠪قائمه ردود المدير \n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"𖠪ارسل الكلمه التي تريد اضافتها")
...
send(msg.chat_id_, msg.id_,"𖠪ارسل الكلمه التي تريد حذفها")
...
send(msg.chat_id_, msg.id_,"𖠪تم ازالة الرد من قائمه الردود")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/S0DRG"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."S0DRG:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."S0DRG:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."S0DRG:insta_bot"..msg.chat_id_) == "open" then
...
end --الكود حصري سورس دراكون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_, msg.id_,' 𖠪 تم مغادرة الجروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '\n 𖠪 تم تعطيل ردود المدير' 
else
Text = '\n 𖠪 بالتاكيد تم تعطيل ردود المدير'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖠪 تم تفعيل ردود المطور' 
else
Text = '\n 𖠪 بالتاكيد تم تفعيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖠪 تم تعطيل ردود المطور' 
else
Text = '\n 𖠪 بالتاكيد تم تعطيل ردود المطور'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖠪 تعال حبي يصيحونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '  هوا ابن الكلب دا الـ ضافك 😂♥ » '..Name
...
database:del(bot_id..'Mod:User'..msg.chat_id_)
database:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖠪 تم تنزيل الكل من الرتب الاتيه \n 𖠪 المميزين ، الادمنيه ، المدراء ، المنشئين \n')
end
...
Text = ' 𖠪 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖠪 بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖠪 تم تعطيل امر اطردني'
else
Text = '\n 𖠪 بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
local rtpg = rtpa
local sofia = {
" 𖠪 اروح فـدوه للـحلوين",
" 𖠪 حلوة حبيبي معليك بالمضغوطين",
" 𖠪 جهرتك منورة ",
" 𖠪 هاي شكد حلو انتة",
" 𖠪 اصلا صوفي احلئ",
" 𖠪 اصلا روظي احلئ",
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n 𖠪 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖠪 معرفك ~⪼ '..username..'\n 𖠪 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖠪 موقعك ~⪼ '..rtpa..'\n 𖠪 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖠪 رسائلك ~⪼ '..Msguser..'\n 𖠪 نسبه تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖠪 السحكات ~⪼ '..edit..'\n 𖠪 نقاطك ~⪼ '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n 𖠪 ايديك ~⪼ '..msg.sender_user_id_..'\n 𖠪 معرفك ~⪼ '..username..'\n 𖠪 رتبتك ~⪼ '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖠪 موقعك ~⪼ '..rtpa..'\n 𖠪 تفاعلك ~⪼ '..Total_Msg(Msguser)..'\n 𖠪 رسائلك ~⪼ '..Msguser..'\n 𖠪 نسبه  تفاعلك ~⪼ '..string.sub(nspatfa, 1,5)..' %\n 𖠪 السحكات ~⪼ '..edit..'\n 𖠪 نقاطك ~⪼ '..NUMPGAME..']\n')
else
...
{
{text = 'العاب متطوره 2🕹️', callback_data="/change-photo"},
},
{ 
...
send(msg.chat_id_, msg.id_, t..'✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ٴ\n𖠪 ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
...
send(msg.chat_id_, msg.id_, '𖠪 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'𖠪 تم تفعيل حساب العمر')
...
send(msg.chat_id_, msg.id_, ' 𖠪 تم تعطيل اوامر التحشيش')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التحشيش") then 
send(msg.chat_id_, msg.id_, '  𖠪 تم تفعيل اوامر التحشيش')
...
send(msg.chat_id_,0," 𖠪 العضو : {["..data.first_name_.."](T.ME/NIU_C)}\n 𖠪 ["..DRAGONAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
