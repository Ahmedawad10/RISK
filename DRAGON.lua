...
if [ ! $token ]; then
echo "✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ ✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE VERA_Info.lua \e[0m"
echo "✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
local f = io.open("./VERA_Info.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./VERA_Info.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1208165035,1614314857}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'ريسك'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "NIU_C")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐈𝐒𝐊")  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/NIU_C"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ♽ العضو ⤶ ['..result.title_..'](t.me/'..(username or 'NIU_C')..')'
status  = '\n ♽ تم ترقيته مطور'
...
usertext = '\n ♽ العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'NIU_C')..')'
status  = '\n ♽ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♽ العضو ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NIU_C')..') \n ♽ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♽ العضو : {["..data.first_name_.."](T.ME/NIU_C)}\n ♽ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♽ عذرا ⤶ {["..data.first_name_.."](T.ME/NIU_C)}\n ♽ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
لتنصيب بوتك علي سورس ريسك اتبع الازرار ♽
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✪ ⁽𝐃𝐞𝐯 𝐌𝐚𝐝𝐢𝐬𝐨𝐧₎ ✪',url="t.me/AAHMEED11"}},
...
if text == 'ماديسون' or text == 'احمد' or text == 'مبرمج ماديسون' then
local Text = [[
ماديسون مبرمج السورس
اتبع الزر إلى تحت ⬇️
...
if text == 'جافا' or text == 'java' or text == 'عمرو' then
local Text = [[
عمرو مطور السورس
اتبع الزر إلى تحت ⬇️
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♽ بواسطه ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'NIU_C')..') \n ♽ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♽ بواسطه ⤶ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NIU_C')..') \n ♽ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/devid100/vsra/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♽ اهلا بك في متجر ملفات ريسك\n ♽ ملفات السورس ↓\n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n\n"
local TextE = "\n✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n ♽ علامة تعني { ✔️ } ملف مفعل\n ♽ علامة تعني { ✖ } ملف معطل\n ♽ قناة سورس ريسك ↓\n".." ♽ [اضغط هنا لدخول](t.me/NIU_C) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/devid100/vsra/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ♽ عذرا الملف لايدعم سورس ريسك \n") 
end
return false
end
...
if text == ("مسح قائمه ريسك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ♽ تم مسح قائمه ريسك')
return false
end

if text == 'قائمه ريسك' and Sudo(msg) then
...
if text == ("رفع ريسك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ريسك @(.*)$") and Sudo(msg) then
local username = text:match("^رفع ريسك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ريسك (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ريسك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ريسك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ريسك @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ريسك @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ريسك (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ريسك (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♽ لعضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'NIU_C')..')'
status  = '\n ♽ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♽ العضو ⤶ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♽ العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'NIU_C')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♽ العضو ⤶ ['..result.title_..'](t.me/'..(text1[3] or 'NIU_C')..')'..'\n ♽ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريسك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ريسك')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."NIU_C:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."NIU_C:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."NIU_C:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."NIU_C:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"♽تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."NIU_C:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."NIU_C:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ريسك يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ريسك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/NIU_C)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/NIU_C)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/NIU_C)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/NIU_C)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/NIU_C)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/NIU_C)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/NIU_C)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/NIU_C)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'NIU_C')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'✪❯─────「𝗥𝗶𝘀𝗸」─────❮✪\n♽ [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐈𝐒𝐊 ](t.me/NIU_C)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ريسك')
